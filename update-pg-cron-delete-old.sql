-- Update the export_workflows_to_json function to delete old files before writing
-- This prevents duplicate files by removing old exports for each workflow
