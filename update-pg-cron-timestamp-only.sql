-- Update the export_workflows_to_json function to use workflow name and updatedAt timestamp
-- This prevents duplicates by using the same filename when updatedAt hasn't changed
...
BEGIN
    ...
    LOOP
        ...
        -- This ensures same workflow with unchanged updatedAt time overwrites the same file (no duplicates)
